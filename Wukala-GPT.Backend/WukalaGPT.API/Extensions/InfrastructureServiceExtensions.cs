...
public static class InfrastructureServiceExtensions
{
    public static string GetPostgresConnectionString(IConfiguration config, string name)
    {
            ...
            connectionString.StartsWith("postgresql://", StringComparison.OrdinalIgnoreCase))
        {
            ...
            return $"Host={uri.Host};Port={port};Database={uri.AbsolutePath.TrimStart('/')};Username={userInfo[0]};Password={userInfo[1]};SSL Mode=Prefer;Trust Server Certificate=true;";
        }
